    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.Order_OrderId, t.Food_FoodId })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.OrderFoods", "Food_FoodId", "dbo.Foods");
            DropForeignKey("dbo.OrderFoods", "Order_OrderId", "dbo.Orders");
            DropForeignKey("dbo.Orders", "ApplicationUserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropIndex("dbo.OrderFoods", new[] { "Food_FoodId" });
            DropIndex("dbo.OrderFoods", new[] { "Order_OrderId" });
